...
const i18n = {
  en: {
    ...
    coachBio: "A certified physical therapist and performance coach who combines clinical knowledge with real-world coaching. Dr. Maged builds programs around your body — not a generic template. Every plan is assessment-driven, injury-aware, and designed to evolve with you.",
  ...
  ar: {
    ...
    coachBio: "أخصائي علاج طبيعي ومدرب أداء يجمع بين المعرفة السريرية والتدريب على أرض الواقع. د. ماجد يبني برامج مخصصة لجسمك - وليس مجرد قوالب جاهزة. كل خطة تعتمد على التقييم، تراعي الإصابات، ومصممة لتتطور معك.",
